...
//
// Files / Shell / Diff are docked-viewer TOGGLES (active = the viewer is open).
// The design's `kind="agent"` is intentionally absent: spawning an agent goes
// through the SpawnSplitBtn + rich launcher, not a bare chip.
