/** Ico — inline 14px stroke icon set. Faithful port of design/components.jsx `Ico`. */
...
export const Ico = {
  ...
  diff: (
    <svg
      ...
      strokeWidth="1.4"
    >
      <path d="M5 3v6M5 13a1 1 0 100-2 1 1 0 000 2zM5 5a1 1 0 100-2 1 1 0 000 2zM11 13V7M11 5a1 1 0 100-2 1 1 0 000 2z" />
    </svg>
  ),
  files: (
    <svg
  ...
  branch: (
    <svg
      ...
      strokeWidth="1.4"
    >
      <path d="M5 3v10M11 3v3a3 3 0 01-3 3H5" />
      <circle cx="5" cy="2.5" r="1.3" />
      <circle cx="11" cy="2.5" r="1.3" />
      <circle cx="5" cy="13.5" r="1.3" />
    </svg>
  ),
  search: (
    <svg
  ...
  bell: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M4 11V7a4 4 0 118 0v4l1.5 1.5h-11L4 11zM6.5 13a1.5 1.5 0 003 0" />
    </svg>
  ),
  container: (
    <svg
    ...
    >
      ...
      <path d="M2.5 5L8 7.5M13.5 5L8 7.5M8 7.5v6" />
    </svg>
  ),
  hub: (
    <svg
